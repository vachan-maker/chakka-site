    ...
    return (
        <>
            <div className='min-h-dvh bg-blue-200 flex flex-col items-center justify-evenly'>
                <div>
                <h1 className={`${RIT_Kutty.className} text-[#2c3e50] text-8xl`}>പഴം Counter</h1>
                ...
                <Image src='/pazham.png' width={400} height={400} onClick={increaseCounter} className="active:animate-bounce" />
            </div>
        </>
    )
}

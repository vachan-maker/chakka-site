...
export default function Card({service}) {
    return (
        <Link href={service.selfurl || service.exturl}>
            <div className='border border-amber-200 rounded-md p-5 hover:bg-base-300 cursor-pointer bg-base-300 m-2 hover:shadow-2xl hover:scale-105 duration-500 ease-in-out'>
